...
func TestAddTransaction(t *testing.T) {
	...
	tx := common.NewTransaction(txID, "alice", "bob", 100, 1)
	...
	invalidTx := common.NewTransaction(invalidID, "", "bob", 100, 1)
...
func TestCreateBlock(t *testing.T) {
	...
	tx2 := common.NewTransaction(ids.GenerateTestID(), "charlie", "dave", 50, 1)
...
func TestCreateBlockWithMaxTxs(t *testing.T) {
	...
	// Add transactions
	for i := 0; i < 10; i++ {
		tx := common.NewTransaction(ids.GenerateTestID(), "alice", "bob", uint64(100+i), uint64(i))
...
func TestSubmitBlock(t *testing.T) {
	...
	tx := common.NewTransaction(ids.GenerateTestID(), "alice", "bob", 100, 1)
	bc.AddTransaction(tx)
