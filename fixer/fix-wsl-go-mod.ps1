...
$script | Out-File -FilePath "fix-go-mod.sh" -Encoding ascii -NoNewline

# Run the script through WSL
wsl -e bash -c "cd /mnt/e/avalanche-parallel && chmod +x fix-go-mod.sh && ./fix-go-mod.sh" 